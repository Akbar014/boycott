<div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Name  </a></div>
<div class="sl-sideleft">
    <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('user.addedUser') }}" class="sl-menu-link @yield('addeduser')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-briefcase tx-22"></i>
                <span class="menu-item-label"> Added User </span>
            </div>
        </a>
