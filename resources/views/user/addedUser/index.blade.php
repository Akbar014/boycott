@extends('user.master')
@section('title') Added User @endsection
@section('addeduser') active @endsection

@section('content')
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="#">Boycott</a>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <div class="modal-body pd-20" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" placeholder="Please Enter your name " class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
